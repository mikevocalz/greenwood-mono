  ...
  render() {
    return (
      <Html lang="en">
        ...
        <body className="scrollbar-thin scrollbar-thumb-[#136f63] scrollbar-track-[#6b9d97] scrollbar-thumb-rounded-full scrollbar-track-rounded-full h-32 overflow-y-scroll bg-gradient-to-r from-red-300 to-red-900">
          <Main />
          <NextScript />
        </body>
      </Html>
